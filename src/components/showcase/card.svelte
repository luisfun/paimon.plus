              ...
              c(
                ...
                ...(a.skills?.map(skill =>
                  c(
                    ...
                    c(`img`, { sx: { position: `absolute`, m: -18, opacity: 0.75 }, src: srcUrl(`TalentBack`, "card-assets") }),
                ...
                .map(stat =>
                  c(
                    ...
                    c(
                      `div`,
                      { sx: { display: `flex` } },
                      c(`img`, { sx: { ml: -4, mr: 10, width: 32, height: 32 }, src: srcUrl(stat.icon, "card-assets") }),
                    ...
                    c(
                      ...
                      ...artifact.flat.reliquarySubstats.map(sub =>
                        c(
                          ...
                          c(`img`, { sx: { ml: 0, width: 32, height: 32 }, src: srcUrl(sub.appendPropId, "card-assets") }),
                          c(
                            `div`,
                            { sx: { mr: 0 } },
                            sub.rolls &&
