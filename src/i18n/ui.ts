...
export const ui = {
  en: {
    ...
    'crit-ratio.references': 'References',
    'crit-ratio.blog-title': 'Ideal ratio of ATK and CRIT (JA)',
  ...
  ja: {
    ...
    'crit-ratio.references': '参考',
    'crit-ratio.blog-title': '攻撃と会心の理想比率',
  ...
  ko: {
    ...
    'crit-ratio.references': '참고',
    'crit-ratio.blog-title': '공격력과 치명타의 이상적 비율(일본어)',
