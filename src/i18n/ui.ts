...
export const ui = {
  ...
  pt: {
    ...
    'uid.error.report': 'Se você denunciar isso em nosso Discord, poderemos lidar com isso mais rapido',
    ...
    'crit-ratio.ATK': 'Balance of ATQ and Crítico',
    'crit-ratio.DEF': 'Balance of DEF and Crítico',
    'crit-ratio.low': 'A baixa pontuação do equipamento faz com que pareça uma especialização',
    // Status
    'Max HP': 'Vida Máxima',
    'Base ATK': 'ATQ Básico',
    HP: 'Vida',
